...
//     return (
//         <>
//             <div className='flex flex-col items-center w-full justify-center h-screen bg-gray-100 space-y-8'>
//                 <div>
//                     <img src="https://nayeshamills.com/cdn/shop/articles/Balanced_Diet_What_is_it_and_Why_is_it_Important.jpg?v=1660738424"
//                         alt="Diet-image" />
//                 </div>
//                 <div className='text-center space-y-4 '>
//                     <h1 className='text-4xl font-bold'>Create Your AI Driven Dirt Plan</h1>
//                 </div>
//             </div>
//         </>
//     )
...
//             <div className="absolute inset-0 bg-gradient-to-b from-white/90 via-white/60 to-green-100/70"></div>
//             {/* Centered Content */}
...
//                 </p>
//                 <button className="mt-8 px-8 py-3 rounded bg-green-500 text-white font-semibold text-lg hover:bg-green-600 transition shadow-lg">
//                     Get Started
//                 </button>
//             </div>
//         </div>
